...
- [Sun Module](sun.md) - Uses observer for rise/set
- [Moon Module](moon.md) - Uses observer for rise/set
- [Visibility Module](visibility.md) - Uses observer for all calculations
